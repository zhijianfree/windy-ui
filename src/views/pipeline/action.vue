    ...
    >
      <el-form v-model="actionForm" size="small" label-width="120px">
        ...
        <el-form-item label="参数列表">
          ...
          <div class="add-btn" @click="addNewItem">
            新增参数
          </div>
        </el-form-item>
        ...
        <el-form-item label="结果条件列表">
          ...
          >
            ...
            <el-col :span="1" class="separate-line">-</el-col>
            <el-col :span="4">
              <el-input placeholder="参数类型" v-model="item.valueType" />
            </el-col>
            <el-col :span="1" class="separate-line">-</el-col>
            <el-col :span="4">
              <el-input placeholder="选择运算服符" v-model="item.operator" />
            </el-col>
            <el-col :span="1" class="separate-line">-</el-col>
            <el-col :span="4">
              <el-input placeholder="期望值" v-model="item.value" />
            </el-col>
          </el-row>
          <div class="add-btn" @click="addNewCondition">
            新增条件
          </div>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    editAction(row) {
      ...
      this.showCreateExecuter = true
      this.actionForm = row
      this.configList = row.paramDetail
      this.compareList = row.results
    },
    removeAction(row) {
    ...
    addAction() {
      ...
      data.paramDetail = this.configList
      data.results = this.compareList
      console.log(data)
